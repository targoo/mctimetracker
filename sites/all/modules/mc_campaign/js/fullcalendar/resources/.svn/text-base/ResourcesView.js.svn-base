...
function ResourcesView(element, calendar, viewName) {
	var t = this;
	
	
	// exports
	t.renderResourcesView = renderResourcesView;
	t.setWidth = setWidth;
	...
	function renderResourcesView(rebuildSkeleton) {
		
		console.log('renderResourcesView');
