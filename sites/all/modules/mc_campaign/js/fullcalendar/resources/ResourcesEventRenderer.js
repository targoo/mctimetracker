...
function ResourcesEventRenderer() {
	var t = this;
	...
	function compileSlotSegs(events) {
		var colCnt = getColCnt(),
			...
			segs=[],
			resources = calendar.getResources(),
			resourcesEvents, visEventEndsForRes;
		for (i=0; i<colCnt; i++) {
			resourcesEvents = eventsForResource(resources[i], events);
			visEventEndsForRes = visEventEndsForResource(resources[i], events);
		
			col = stackSegs(sliceSegs(resourcesEvents, visEventEndsForRes, d, addMinutes(cloneDate(d), maxMinute-minMinute)));
