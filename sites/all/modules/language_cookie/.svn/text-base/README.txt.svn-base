...
- Enable "Cookie" detection method and re-arrange it as you see fit. Recommended setup is: URL -> Session -> Cookie


SUPPORT
-------

If you find a bug or have a feature request please file an issue: http://drupal.org/node/add/project-issue/language_cookie
