 ...
 */
  ...
  //$params['site_name']
  //http://four.example.com:8888/sites/default/files/styles/thumbnail/public/caroline/logo%20transparent%20-%20mini.jpg
                                    	...
                                    	<tr>
                                        	<td valign="top">
                                            	<div mc:edit="std_preheader_content">
                                                	 <?php echo $params['site_name'] ?> - <?php echo t('Campaign Reminder'); ?>
                                                </div>
                                            </td>
                                            <!-- *|IFNOT:ARCHIVE_PAGE|* -->
                                	...
                                	<table border="0" cellpadding="0" cellspacing="0" width="600" id="templateHeader">
                                        <tr>
                                            <td class="headerContent">
                                            	...
                                            	<img src="http://four.example.com:8888/sites/default/files/styles/thumbnail/public/caroline/logo%20transparent%20-%20mini.jpg" style="max-width:600px;" id="headerImage campaign-icon" mc:label="header_image" mc:edit="header_image" mc:allowdesigner mc:allowtext />
                                            	<!-- img src="http://www.mctimetracker.com/sites/all/themes/mctimetracker/images/html_header.jpg" style="max-width:600px;" id="headerImage campaign-icon" mc:label="header_image" mc:edit="header_image" mc:allowdesigner mc:allowtext / -->
                                                    ...
                                                    <tr>
                                                        <td valign="top">
                                                            <div mc:edit="std_content00">
                                                        	    <h1 class="h1"><?php echo t('Reminder'); ?></h1>
